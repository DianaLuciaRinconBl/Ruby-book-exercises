...
# however, break stops the loop after the first iteration. Use next
# to modify the code so that the loop iterates until either number_a
# or number_b equals 5. Print "5 was reached!" before breaking out of
# the loop.
