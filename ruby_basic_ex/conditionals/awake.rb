...
#IMPORTANT!!!
# In this exercise, we aren't printing the string immediately, instead,
# we're returning the string to be printed at a later time. We can do
# this quite easily by saving the return value of the if statement to a variable.
#
